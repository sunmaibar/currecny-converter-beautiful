...
const initallyDisplayedCurrencies = ["AUD", "USD", "EUR", "JPY"]
...
function addCurrencyListClick(e) {
    ...
    if (!clickedListItem.classList.contains("disable")) {
...
function currenciesListClick(e) {
    ...
    for (let i = 0; i < currencies.length; i++) {
        addCurrencyList.insertAdjacentHTML(
            ...
            `<li data-currency=${currencies[i].abbreviation}>
                <img class="flag" src=${currencies[i].flagURL}><span>${currencies[i].abbreviation} -
...
function newCurrenciesListItem(currency) {
    ...
    currenciesList.insertAdjacentHTML(
        ...
        `<li class="currency ${currency.abbreviation === baseCurrency ? "base-currency" : ""}" id=${currency.abbreviation}>
            ...
            <div class="info">
                <p class="input"><span class="currency-symbol">${currency.symbol}</span><input placeholder="0.00000" value=${inputValue}></p>
